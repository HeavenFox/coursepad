...
const STATE_READY = 0, STATE_THINKING = 1, STATE_DONE = 2, STATE_NO_VALID = 3;
const STATE_SAVED = 4, STATE_REVERTED = 5;
...
var Magic = React.createClass({
    ...
    render: function() {
        ...
        case STATE_THINKING:
            content = <div className="utilities-content">
                <p>Thinking...</p>
                <p className="side" onClick={this._cancel}>Cancel</p>
            </div>
            break;
        case STATE_DONE:
            content = <div className="utilities-content">
                <p>We found a good schedule</p>
                <p className="side linkish" onClick={this._next}>Think Another</p>
                <p className="side linkish" onClick={this._save}>Save</p>
                <p className="side linkish" onClick={this._revert}>Revert</p>
            </div>
            break;
        case STATE_NO_VALID:
            content = <div className="utilities-content">
                <p>Cannot Find a Schedule</p>
                <p>Likely the courses you have chosen conflict with each other. Try removing some.</p>
            </div>
        ...
        case STATE_SAVED:
            content = <div className="utilities-content">
                <p>Schedule Saved</p>
                <p className="side linkish" onClick={this._goBack}>Back</p>
            </div>
            break;
        case STATE_REVERTED:
            content = <div className="utilities-content">
